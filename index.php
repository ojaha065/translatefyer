...
<html lang="en">
    ...
    <head>
        ...
        <meta name="revised" content="Wednesday, August 8th, 2018" />
    ...
    <body>
        ...
        <h1>Welcome to Translatefyer</h1>
            ...
            <p><b>What is Translatefyer?</b> Translatefyer runs texts throught multiple layers of Google's machine translation. As you know, Google Translate often returns hilarious results. We just take it a step further by running the input throught Google Translate multiple times and switching languages between.</p>
            <p><b>But why?</b> I dunno, for fun, I guess? This project was heavily inspired by the popular <a href="https://www.youtube.com/watch?v=957K58gMbPA" target="_blank">Google Translate Sings</a> videos by <a href="https://www.youtube.com/channel/UCP2-S6-M9ZvlY8t7cRn4O6A" target="_blank">Malinda Kathleen Reese</a>.</p>
